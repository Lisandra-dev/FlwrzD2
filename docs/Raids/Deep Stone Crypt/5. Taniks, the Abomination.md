...
During [[5. Taniks, the Abomination#Part 2 Everything All at Once|Part 2]], things can be divided into a few different roles:  
- One operator  
- One scanner  
- One suppressor  
- Two runners  
...
If Taniks wasn't sent to final stand from here, the fireteam will have to repeat all of the above steps again from [[5. Taniks, the Abomination#Part 1 Travelling Taniks|the beginning]].  
