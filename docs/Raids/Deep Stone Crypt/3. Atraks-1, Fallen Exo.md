...
> There are four Atraks clones on either floor. Usually on the left, middle, and right with two clones in one section. Their locations are *super* important for [DPS](3.%20Atraks-1,%20Fallen%20Exo.mdpart-2-dps).  
...
- The scanner buff needs to be [sent downstairs](3.%20Atraks-1,%20Fallen%20Exo.mdground-floor) via the terminal.  
...
Up next is a beautiful space walk with some pretty amazing music. Crank the volume up and head out to meet up with [an old friend](./4.%20Rapture.md).